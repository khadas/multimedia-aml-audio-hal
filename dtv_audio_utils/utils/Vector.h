...
#ifndef DRMPLAYER_VECTOR_H
#define DRMPLAYER_VECTOR_H
...
public:
     ...
     */
     ...
     inline dp_state        sort(compar_t cmp);
     inline dp_state        sort(compar_r_t cmp, void* state);
...
template<class TYPE> inline
dp_state Vector<TYPE>::sort(Vector<TYPE>::compar_t cmp) {
    return VectorImpl::sort(reinterpret_cast<VectorImpl::compar_t>(cmp));
}

template<class TYPE> inline
dp_state Vector<TYPE>::sort(Vector<TYPE>::compar_r_t cmp, void* state) {

...
static int (*_aml_dts_postprocess_dynamic_parameter_set)(void *pDtsPPInstance, unsigned int init_argc, char *init_argv[]);
...
static int _get_dtsx_function_symbol(void)
{
    ...
    _aml_dts_postprocess_dynamic_parameter_set = (int (*)(void *, unsigned int, char **))dlsym(_DtsxDecoderLibHandler, "dtsx_postprocess_dynamic_parameter_set");

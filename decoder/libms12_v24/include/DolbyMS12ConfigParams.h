...
public:
    ...
    virtual void setLFEpresentInSystemSoundsIn(int val)
    {
    ...
    virtual void setDAPSurroundVirtualizer(DAPSurroundVirtualizer *dapVirtualizerParameters)
    {
        if (dapVirtualizerParameters) {
            memcpy(&DeviceDAPSurroundVirtualizer, dapVirtualizerParameters, sizeof(DeviceDAPSurroundVirtualizer));
        }
    }

 ...
 * mysnc stub.
 *
 * Author: xingri.gao@amlogic.com
 */
#ifndef AML_AVSYNC_STUB_H__
#define AML_AVSYNC_STUB_H__
...
#define AV_SYNC_INVALID_PTS 0xFFFFFFFF
#define AV_SYNC_INVALID_PAUSE_PTS AV_SYNC_INVALID_PTS
 ...
 * This API should be VSYNC triggered. Used only in VIDEO_MONO mode.
 * Params:
 *   @sync: AV sync module handle
...
/* Pop video frame for next VSYNC. This API should be VSYNC triggered.
 * Params:
 *   @sync: AV sync module handle
 * Return:
 ...
 * Params:
 *   @sync: AV sync module handle
 *   @pts: current audio pts (considering delay)
 ...
 *  The status will become false when the switching has finished or being terminated
 * Params:
 *   @sync: AV sync module handle

...
typedef enum AML_MIXER_CTRL_ID {
    ...
    AML_MIXER_ID_DIGITAL_MODE,
    AML_MIXER_ID_DRC_CONTROL,
    AML_MIXER_ID_OUTPUT_SELECT,
    ...
    AML_MIXER_ID_EQ_LCH_VOLUME,
    AML_MIXER_ID_EQ_RCH_VOLUME,
